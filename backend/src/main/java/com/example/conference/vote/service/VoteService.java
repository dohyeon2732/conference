...
public class VoteService {
    ...
    public AgendaVoteResultResponse getAgendaVoteResult(Long agendaId) {
        long agreeCount = voteRepository.countByAttendance_Agenda_AgendaIdAndVoteValue(
                agendaId,
                VoteType.AGREE
        );
        long disagreeCount = voteRepository.countByAttendance_Agenda_AgendaIdAndVoteValue(
                agendaId,
                VoteType.DISAGREE
        );
        long abstainCount = voteRepository.countByAttendance_Agenda_AgendaIdAndVoteValue(
                agendaId,
                VoteType.ABSTAIN
        );
