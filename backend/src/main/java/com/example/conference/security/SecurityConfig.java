...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth->auth.requestMatchers("/agenda/**","/attendance/**","/user/login","/user/**","/state/**","/dept/**","/user/count/stream","/user/count","/user/dept","/manager/**","/swagger-ui/**","/v3/api-docs/**","/swagger-ui.html").permitAll().anyRequest().authenticated())
